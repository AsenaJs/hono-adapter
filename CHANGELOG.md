...
- dd82fa5: `getParseBody()` now returns the schema's output when the route declares a `form` validator, matching what `getBody()` already does for `json`.
